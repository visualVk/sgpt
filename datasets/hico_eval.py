...
class HICOEvaluator():
    def __init__(self, preds, gts, subject_category_id, rare_triplets, non_rare_triplets, correct_mat, save_hoi_path=False, eval_mode='default'):
        ...
        for img_gts in gts:
            ...
            for hoi in self.gts[-1]['hoi_annotation']:
                triplet = (self.gts[-1]['annotations'][hoi['subject_id']]['category_id'],
                           self.gts[-1]['annotations'][hoi['object_id']
                                                       ]['category_id'],
                           hoi['category_id'])
        ...
        if not isinstance(save_hoi_path, bool) and save_hoi_path != '':
            print(f'will be saved in {save_hoi_path}')
            with open(save_hoi_path, 'w') as f:
    ...
    def compute_map(self):
        ...
        for triplet in self.gt_triplets:
            ...
            if len(tp) == 0:
                ...
                if triplet in self.rare_triplets:
                    ...
                    print(
                        'Warning: triplet {} is neither in rare triplets nor in non-rare triplets'.format(triplet))
                continue
        ...
        print('--------------------')
        print('mAP: {} mAP rare: {}  mAP non-rare: {}  mean max recall: {}'.format(m_ap,
              m_ap_rare, m_ap_non_rare, m_max_recall))
        print('--------------------')
