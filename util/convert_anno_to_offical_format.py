...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'convert anno to official format', add_help=False)
...
if __name__ == '__main__':
    ...
    # Generate_HICO_detection('data/hico_20160224_det/add_file/hico_gen.json', 'data/hico_20160224_det/add_file/')
    Generate_HICO_detection(args.src_path, args.des_path)